# Vs Code Client Specification

**Status: foundation; not implemented.**

## Contract

Purpose: provide the bounded Vs Code Client responsibility within an evidence-backed investigation. It does not inherit filesystem, execution, network, write, or retention authority from another component.
