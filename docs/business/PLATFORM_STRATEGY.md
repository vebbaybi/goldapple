...
Define the platform strategy decisions needed to preserve local-first operation, evidence provenance, least privilege, privacy, reversibility, and honest public status.
