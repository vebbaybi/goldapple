...
Define the hallucination controls decisions needed to preserve local-first operation, evidence provenance, least privilege, privacy, reversibility, and honest public status.
