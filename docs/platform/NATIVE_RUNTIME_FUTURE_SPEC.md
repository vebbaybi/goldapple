# Native Runtime Future Spec

**Status: RESEARCH — NOT IMPLEMENTED.** This capability is optional future architecture and is not required for MVP or V1.

## Purpose

Define the native runtime future spec decisions needed to preserve local-first operation, evidence provenance, least privilege, privacy, reversibility, and honest public status.
