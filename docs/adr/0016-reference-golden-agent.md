# ADR-0016: Reference Golden Agent
...
Golden Apple needs a reviewable decision for reference golden agent while the repository contains no product implementation.

## Decision

Adopt this direction as research only; it creates no MVP dependency.
